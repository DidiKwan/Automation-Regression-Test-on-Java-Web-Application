...
public class HealthCheckCR {
  ...
  public void setUp(String UN) throws Exception {
    System.setProperty("webdriver.chrome.driver", "C:/Users/username/Desktop/Workspace/chromedriver.exe");
  ...
  public void CreateUser() throws Exception {
    ...
    driver.findElement(By.id("portlet_inst_CountryUserList{actionForm.email}"))
        .sendKeys("Didi.Kwan@externals.company.com");
  ...
  public void RetrievePassword() throws Exception {
    ...
    driver.findElement(By.id("{actionForm.email}")).sendKeys("Didi.Kwan@externals.company.com");
  ...
  public void DownloadReports() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        ...
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
        }
        driver.close();
      }
    }
  ...
  public void SalesOrder() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'SO_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
  ...
  public void ReturnOrder() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'RO_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
  ...
  public void Invoice() throws Exception {
    ...
    filename = driver.findElement(By.xpath("//td[6]/a/span")).getText();
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'INV_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
  ...
  public void CreditNote() throws Exception {
    ...
    assertTrue(isElementPresent(By.id("portlet_inst_creditNote_printPdf")), "Credit Note Page Fail");
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'CN_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
  ...
  public void StockOrder() throws Exception {
    ...
    filename = driver.findElement(By.xpath("//*[@id='content']/div/div[2]/div[5]/div[1]/div/div/div/div[2]/div[2]/div"))
        .getText();
    assertEquals(filename, "REEBOK 1 item(s)");
  ...
  public void PickingNote() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'PN_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
  ...
  public void ShipmentNote() throws Exception {
    ...
    while (iterator.hasNext()) {
      ...
      if (!mainWindowHandle.equalsIgnoreCase(ChildWindow)) {
        driver.switchTo().window(ChildWindow);
        filename = driver.findElement(By.xpath("//a[contains(text(),'SN_98')]")).getText();
        driver.findElement(By.linkText(filename)).click();
        boolean check = new File("C:/Users/username/Downloads", filename).exists();
        while (!check) {
          check = new File("C:/Users/username/Downloads", filename).exists();
